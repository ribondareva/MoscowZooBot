...
Проект еще не полностью реализован, но уже содержит основные функциональные элементы, такие как парсер данных с сайта. В будущем планируется добавление дополнительных функций, улучшение алгоритмов подбора животных и улучшение масштабируемости бота.
